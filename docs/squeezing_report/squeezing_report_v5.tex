...
\item v5 이상($\mathrm{QE}=1$, loss$=0$) 산출물:
      \texttt{analysis/squeezing\_frontier\_ideal\_v5/squeezing\_frontier.npz}, 그림
...
\item v5 loss$=0$ TPD/beam-angle 상세 스캔 산출물:
      \texttt{analysis/squeezing\_frontier\_ideal\_v5\_tpd\_angle\_detail/squeezing\_tpd\_angle\_detail.npz},
      그림 \texttt{docs/squeezing\_report/squeezing\_frontier\_ideal\_v5\_tpd\_angle\_detail.png}.
      생성 스크립트는 \texttt{Analysis/scan\_squeezing\_v5\_loss0\_tpd\_angle\_detail.py}.
