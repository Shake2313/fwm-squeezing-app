...
V5 = REPO / "analysis" / "squeezing_frontier_finite_loss_v5" / "squeezing_frontier.npz"
...
src_png = REPO / "analysis" / "squeezing_frontier_finite_loss_v5" / "squeezing_frontier.png"
if src_png.exists():
