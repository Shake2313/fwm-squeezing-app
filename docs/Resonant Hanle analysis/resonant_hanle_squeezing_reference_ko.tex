...
%   xelatex "docs/Resonant Hanle analysis/resonant_hanle_squeezing_reference_ko.tex"
%   cd "docs/Resonant Hanle analysis"; xelatex resonant_hanle_squeezing_reference_ko.tex
...
\graphicspath{{../../analysis/squeezing/}{analysis/squeezing/}{./}}
...
실행 예시는 다음과 같다.
\begin{verbatim}
python analysis\squeezing\resonant_hanle_squeezing_reference.py ^
  --config-json analysis\squeezing\resonant_hanle_experiment_config.example.json ^
...
\texttt{analysis/squeezing/resonant\_hanle\_experiment\_config.example.json}에 반영하는 것이 좋다.
